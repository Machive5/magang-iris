...
double calcDistance(float r){
    ...
    hasil = (1.5132851736838930*pow(10,2))+(-2.1225457381657278*r)+(1.4383492118754407*pow(10,-2)*pow(r,2))+(-4.7379848523256183*pow(10,-5)*pow(r,3))+(6.1464904018921641*pow(10,-8)*pow(r,4));
    return hasil;
}
